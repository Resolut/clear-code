...
# 3.2.1
# Filterable, Sortable - интерфейсы реализации фильтров и их модификации для получения запросов из базы данных

# 3.2.2
# Pageable - интерфейс для получения порциями (страницами) результатов запроса (для реализации пагинации)

# 3.2.3
# BaseStream - абстрактный класс описывающий методы взаимодействия с потоком данных ввода-вывода.
# SocketStream - наследует BaseStream и реализует интерфейсы для работы с потоком ввода-вывода

# 3.2.4
# Descriptor - абстрактный класс, описывающий методы создания объекта,
# поддерживающего базовый протокол дескриптора.
# TypedDescriptor - наследует абстрактный класс Descriptor,
# и реализует методы проверки типов атрибутов объекта
